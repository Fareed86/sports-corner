...
const SingleJersey = () => {
    ...
    const totalPrice = (jersey.price * quantity).toFixed(2);
            ...
            <div className="min-h-screen flex  justify-center bg-base-200">
                <div className="card lg:card-side bg-base-100 shadow-xl w-3/4 lg:h-[500px] mx-auto p-4">
                    ...
                    <div className="card-body lg:w-1/2">
                        <h2 className="card-title text-2xl mx-auto font-semibold text-blue-400">{jersey.name}</h2>
                        ...
                        {/* Description */}
                        <p className="text-gray-500 mx-auto text-2xl">{jersey.description}</p>
                        {/*product size choose */}
